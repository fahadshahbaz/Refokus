...
const Navbar = () => {
  return (
    <div className="max-w-screen-xl py-6 mx-auto flex items-center justify-between border-b-2 border-zinc-700">
      <div className="nleft flex items-center">
      <img src={logo} alt="Refokus logo" />
      <div className="hidden links sm:flex gap-14 ml-20 text-white">
